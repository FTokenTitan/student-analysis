...
student_name = "Jamiu Muheebulah Ayinde" # string
matric_number = "22/66MB111" # string
age = 19 # integer
cgpa = 4.5 # float
is_active = True # boolean
courses_registered = ["FIN311", "FIN317", "GSE301", "FIN323"] # list of strings
grades = {"FIN311": "A", "FIN317": "A", "GSE301": "A", "FIN323": "A"} # dictionary
score = {"FIN311": "85", "FIN317": "91", "GSE301": "97", "FIN323": "74"} # dictionary
...
student_names = ["Jamiu Muheebulah Ayinde", "Salau Khaleemat Busayo", "Akinlade Sofiu Gbolahan", "Abdulrasaq Shakirat Boluwatife", "Balogun Fathia"]

#a dictionary for each student
students = [
    {
          "name": "Jamiu Muheebulah Ayinde",
        "matric_no": "22/66MB111",
        "age": 19,
        "cgpa": 4.5,
        "is_active": True,
    ...
    {
        "name": "Salau Khaleemat Busayo",
        "matric_no": "22/66MB172",
        "age": 21,
        "cgpa": 4.71,
        "is_active": True,
        "outstanding_courses": 0,
    ...
    {
        "name": "Abdulrasaq Shakirat Boluwatife",
...
set_pass = {"Jamiu Muheebulah Ayinde", "Salau Khaleemat Busayo", "Akinlade Sofiu Gbolahan", "Abdulrasaq Shakirat Boluwatife"}

# Set of students with CGPA above 4.0 (Merit)
set_merit = {"Jamiu Muheebulah Ayinde", "Salau Khaleemat Busayo", "Akinlade Sofiu Gbolahan", "Abdulrasaq Shakirat Boluwatife"}
...
students = [
    {"name": "Jamiu Muheebulah Ayinde", "cgpa": 4.5},
    {"name": "Salau Khaleemat Busayo", "cgpa": 4.71},
    {"name": "Akinlade Sofiu Gbolahan", "cgpa": 4.45},
    {"name": "Abdulrasaq Shakirat Boluwatife", "cgpa": 4.05},
    {"name": "Balogun Fathia", "cgpa": 3.43}
]
...
student_scores = {
    "Jamiu Muheebulah Ayinde": {"FIN311": 85, "FIN317": 91, "GSE301": 97, "FIN323": 74},
    "Salau Khaleemat Busayo": {"FIN311": 97, "FIN317": 92, "GSE301": 98, "FIN323": 85},
    "Akinlade Sofiu Gbolahan": {"FIN311": 85, "FIN317": 91, "GSE301": 97, "FIN323": 74},
    "Abdulrasaq Shakirat Boluwatife": {"FIN311": 67, "FIN317": 91, "GSE301": 97, "FIN323": 65},
    "Balogun Fathia": {"FIN311": 56, "FIN311": 67, "GSE301": 92, "FIN323": 90}
}
...
print(identify_type({"name": "Juliet", "age": 20}))
